    ...
    public partial class Form3L : Form
    {
        ...
        private void glControl1_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            ...
            else if (e.KeyCode == Keys.D1)
            {
                ...
                _lSystem.LoadProductionFromFile(EngineLoop.PROJECT_PATH + @"\Rules\bushlike2.rul");
                string words = _lSystem.GenerateStochastic(axiom: "plant", n: 5, delta: 18.0f);
                ...
                (RawModel3d branch, RawModel3d leaf) = LoaderLSystem.Load3dWithLeaf(words, _lSystem.Delta, 1.0f);
                
                Entity entity = new Entity(branch, PrimitiveType.Lines);
                entity.Material = Material.Red(1.0f);
                entities.Add(entity);
